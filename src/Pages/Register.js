                ...
                <div className=" w-full h-full flex justify-center items-center bg-white">
                    <div className="w-[400px]">
                        ...
                        <div className=" w-full">
                            <div className={` px-2 pb-1 border rounded relative ${currentFocusedField === "name" ? " border-[#6C5DD3]" : " border-gray-300"} `}>
                                <label className={` px-1 absolute -top-[14px] left-5 bg-white  text-sm ${currentFocusedField === "name" ? "text-[#6C5DD3]" : "text-gray-500"} font-semibold`}>Name</label>
                                <input onFocus={() => { toggleFocusedField("name") }} onBlur={() => { toggleFocusedField("") }} value={name} onChange={(e) => setName(e.target.value)} type="text" className="border-none w-full focus:outline-none pt-2" />
                            </div>
